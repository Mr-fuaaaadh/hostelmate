...
SECRET_KEY = 'django-insecure-m15ck1osn-755%&%#_o7pe=%k49^cko&-#6-@gu2)+#^iyl4w&'
...
MIDDLEWARE = [
    ...
    "hostelmate.middlewares.DisableCSRFMiddleware",
...
CSRF_TRUSTED_ORIGINS = [
    "https://register-burst-tested-appearance.trycloudflare.com",
    "http://127.0.0.1:8080",
    "http://127.0.0.1:8080",
]


# Allow cookies and auth headers if using JWT or session auth
...
SIMPLE_JWT = {
    'ACCESS_TOKEN_LIFETIME': timedelta(days=10),   # <-- 10 days
